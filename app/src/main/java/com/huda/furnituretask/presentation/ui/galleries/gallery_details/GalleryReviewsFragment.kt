...
import com.huda.furnituretask.databinding.GalleryReviewsFragmentBinding
...
@AndroidEntryPoint
class GalleryReviewsFragment : Fragment() {
    private var _binding: GalleryReviewsFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = GalleryReviewsFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
